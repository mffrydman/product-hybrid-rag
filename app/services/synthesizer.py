...
class SynthesizedResponse(BaseModel):
    ...
    confiability: str = Field(
        description="From 0 to 1,the confidence level indicating how well the retrieved product matches the user's query intent and how relevant it is"
    )
...
class Synthesizer:
    SYSTEM_PROMPT = """
    # Role and Purpose
    You are an AI assistant for an e-commerce system. Your task is to synthesize a coherent and helpful answer
